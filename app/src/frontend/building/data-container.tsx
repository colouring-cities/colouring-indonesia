  ...
  > {
    ...
    static getDerivedStateFromProps(props, state): DataContainerState {
      ...
      for (let key in dataFields) {
        let fieldName =
          props.building == undefined ? undefined : props.building[key];
        if (
          dataFields[key].category == props.cat &&
          fieldName != null &&
        ...
        <Translation>
          {(t, { i18n }) => (
            <section id={this.props.cat} className="data-section">
              ...
              title={i18n.language === 'id' ? this.props.title_id : this.props.title_en}
              >
              ...
              <div className="section-body">
                {this.props.inactive ? (
                  <Fragment>
                    <WrappedComponent
                      intro={i18n.language === 'gr' ? this.props.intro_id : this.props.intro_en}
                      building={this.props.building}
                      mode={this.props.mode}
                      edited={false}
                      copy={copy}
