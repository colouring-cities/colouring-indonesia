...
const ConstructionView: React.FunctionComponent<CategoryViewProps> = (
  ...
  let construction_secondary_material_title =
    dataFields.construction_secondary_materials.title_en;
  let construction_secondary_material_tooltip =
    dataFields.construction_secondary_materials.tooltip_en;
  ...
  if (i18next.language === "id") {
    construction_core_material_title =
      dataFields.construction_core_material.title_id;
    construction_core_material_tooltip =
      dataFields.construction_core_material.tooltip_id;
     construction_secondary_material_title =
      dataFields.construction_secondary_materials.title_id;
     construction_secondary_material_tooltip =
      dataFields.construction_secondary_materials.tooltip_id;
     construction_roof_covering_title =
      dataFields.construction_roof_covering.title_id;
     construction_roof_covering_tooltip =
      dataFields.construction_roof_covering.tooltip_id;
  }
  return (
    <Fragment>
      {/* <SelectDataEntry
      ...
      /> */}
      <SelectDataEntryMultiLingual
        title={construction_secondary_material_title}
        slug="construction_secondary_materials"
        value={props.building.construction_secondary_materials}
        tooltip={construction_secondary_material_tooltip}
        mode={props.mode}
        copy={props.copy}
        onChange={props.onChange}
      />
