...
const LAYER_QUERIES = {
    ...
    construction_core_material: `
        SELECT
            geometry_id,
            construction_core_material AS construction_core_material
        FROM
            buildings
        WHERE
    ...
    planning_combined: `
        SELECT
            ...
            (
                CASE
                    WHEN planning_list_cat = 1 and planning_list_grade = 1 THEN 'Grade I Listed'
                    WHEN planning_list_cat = 1 and planning_list_grade = 2 THEN 'Grade II* Listed'
                    WHEN planning_list_cat = 1 and planning_list_grade = 3 THEN 'Grade II Listed'
    ...
    landuse: `
        SELECT
            ...
            current_landuse_group as current_landuse_group,
